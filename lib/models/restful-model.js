(function() {
  ...
  module.exports = RestfulModel = (function() {
    ...
    RestfulModel.prototype.toJS = function() {
      return this.toJSON(true)
    }

    RestfulModel.prototype.toJSON = function(__toJS) {
      var attr, json, key, ref, value;
      json = {};
      ref = this.attributes();
      for (key in ref) {
        attr = ref[key];
        value = attr.toJSON(this[key], __toJS);

        if (value != null) {
          json[__toJS ? attr.modelKey : attr.jsonKey] = value;
        }
      }
